							...
							? ((this.iframe = iframe),
							  this.isIOS_() &&
									window.addEventListener(
										'devicemotion',
										this.onDeviceMotion_.bind(this),
										!1
									))
				...
				function (_dereq_, module, exports) {
					function Player(selector, contentInfo) {
						...
						;(this.iframe = iframe),
							...
							(this.isPaused = !1),
							(this.isMuted = !1),
							void 0 !== contentInfo.muted && (this.isMuted = contentInfo.muted),
							(this.currentTime = 0),
							(this.duration = 0),
							(this.volume = void 0 != contentInfo.volume ? contentInfo.volume : 1),
							Util.isIOS() && this.injectFullscreenStylesheet_()
					}
					...
					;((Player.prototype = new EventEmitter()).addHotspot = function (hotspotId, params) {
						...
						(Player.prototype.onMessage_ = function (event) {
							...
							if (message && message.type) {
								...
								switch (type) {
									...
									case 'paused':
										;(this.isPaused = data),
											this.isPaused ? this.emit('pause', data) : this.emit('play', data)
										break
						...
						(Player.prototype.setFakeFullscreen_ = function (isFullscreen) {
							isFullscreen
								? this.iframe.classList.add('vrview-fake-fullscreen')
								: this.iframe.classList.remove('vrview-fake-fullscreen')
						}),
						...
						(Player.prototype.getEmbedUrl_ = function () {
							...
							return split.slice(0, split.length - 2).join('/') + '/iframe/iframe.html'
						}),
				...
				function (_dereq_, module, exports) {
					...
					;(Util.isDataURI = function (src) {
						...
						(Util.isWebGLEnabled = function () {
							...
							if (null == gl)
								try {
									;(gl = canvas.getContext('experimental-webgl')), (experimental = !0)
								} catch (x) {
									gl = null
								}
							return !!gl
						...
						(Util.parseBoolean = function (value) {
							return (
								'false' != value && 0 != value && ('true' == value || 1 == value || !!value)
							)
						}),
						(Util.relativeToAbsolutePath = function (base, relative) {
							for (
								var stack = base.split('/'), parts = relative.split('/'), i = 0;
								i < parts.length;
								i++
							)
